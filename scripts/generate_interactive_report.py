...
<p><strong>Key insight:</strong> On matched targets (23 pairs per GTEx tissue, 19&ndash;21 per TCGA cancer after expression filtering), SecAct wins direction in 29/29 GTEx tissues and 32/33 TCGA cancer types, with 23/29 and 31/33 reaching significance (q&lt;0.05). The sole exception is Acute Myeloid Leukemia (&Delta;=&minus;0.08, q=0.83). This consistency across 61 of 62 strata indicates the SecAct advantage holds at the individual tissue/cancer level, not only in aggregate. On total targets, SecAct wins in 28/29 GTEx tissues (21 significant) and 30/33 TCGA cancers (15 significant); the few CytoSig-favored strata (Brain in GTEx; Kidney Chromophobe, Ovarian, Uveal Melanoma in TCGA) are all non-significant. Because this comparison uses the same 23&ndash;32 matched cytokines, the difference reflects per-target signature performance rather than target count. The largest &Delta; values occur in Small Intestine (+0.55), Vagina (+0.34), Pancreatic (+0.34), and Head &amp; Neck (+0.27); the smallest in Heart (+0.06), Skin (+0.06), Uveal Melanoma (+0.07), and Kidney Chromophobe (+0.10).</p>
</div>
