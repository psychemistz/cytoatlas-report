...
<p><strong>Key insight:</strong> On matched targets (23 pairs per GTEx tissue, 19&ndash;21 per TCGA cancer after expression filtering), SecAct wins direction in 29/29 GTEx tissues and 32/33 TCGA cancer types, with 23/29 and 31/33 reaching significance (q&lt;0.05). The sole exception is Acute Myeloid Leukemia (&Delta;=&minus;0.08, q=0.83), a low-sample liquid tumor. This near-unanimous result across 61 of 62 strata rules out Simpson&rsquo;s paradox. On total targets, SecAct wins in 28/29 GTEx tissues (21 significant) and 30/33 TCGA cancers (15 significant); the few CytoSig-favored strata (Brain in GTEx; Kidney Chromophobe, Ovarian, Uveal Melanoma in TCGA) are all non-significant. Since SecAct outperforms CytoSig on the <em>same</em> matched cytokines, the advantage is not about target breadth but about <strong>signature quality</strong>. SecAct&rsquo;s spatial correlation signatures capture tissue-context-dependent regulation that CytoSig&rsquo;s median log2FC signatures miss. The advantage is largest in tissues with complex cellular microenvironments (GTEx: Small Intestine &Delta;=+0.55, Vagina +0.34; TCGA: Pancreatic +0.34, Head &amp; Neck +0.27) and smallest in homogeneous or low-cytokine contexts (GTEx: Heart +0.06, Skin +0.06; TCGA: Uveal Melanoma +0.07, Kidney Chromophobe +0.10).</p>
</div>

<!-- Cross-Platform Comparison: bulk vs pseudobulk -->
<h3>4.4 Cross-Platform Comparison: Bulk vs Pseudobulk
    <a href="stats_section_4.1.html#cross-platform-comparison" style="font-size:14px;font-weight:400;color:var(--blue);text-decoration:none;">[Statistical Methods]</a></h3>
<div class="plotly-container">
...
<div class="callout">
<p><strong>Key patterns in scatter data:</strong> IL1B is the most consistently well-correlated target across all 6 datasets and both signatures (&rho;=0.37&ndash;0.77). CD40L and TRAIL show a CytoSig-specific sign reversal in CIMA (&rho;=&minus;0.48/&minus;0.46) and Inflammation Main (&rho;=&minus;0.55/&minus;0.54), while SecAct maintains positive correlations for the same targets (CD40LG &rho;=0.14&ndash;0.71; TNFSF10 &rho;=0.31&ndash;0.77 except scAtlas Normal &minus;0.004).</p>
