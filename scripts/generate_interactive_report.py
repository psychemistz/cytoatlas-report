...
<p><strong>Key finding:</strong> Using all targets, SecAct shows significant bulk&ndash;pseudobulk differences in most strata (11/13 GTEx tissues, 5/11 TCGA cancers), while CytoSig shows almost none (1/13, 0/11). However, the <em>Matched</em> tabs reveal this is a <strong>target-set effect, not a method effect</strong>: when restricted to the same 32 shared targets, both CytoSig and SecAct show no significant platform differences (0/13 and 0/13 for GTEx; 0/11 and 1/11 for TCGA). The apparent platform sensitivity in SecAct&rsquo;s full panel is driven by its ~1,000 additional secreted-protein targets&mdash;many with weaker expression&ndash;activity signals that are more susceptible to technical differences between bulk and pseudobulk. Core cytokine targets are platform-robust.</p>
</div>
